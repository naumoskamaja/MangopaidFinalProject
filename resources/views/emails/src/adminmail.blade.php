                                        ...
                                        <tr style="direction:ltr;">
                                            <td align="center" style="direction:ltr;font-size:0px;padding:0;"
                                                ...
                                                <div
                                                    ...
                                                    {{$myData['order']->name}} placed order #{{$myData['order']->id}}
                                                    on {{ \Carbon\Carbon::parse($myData['order']->created_at)->format('M d  H:i') }}
                                                    at {{ \Carbon\Carbon::parse($myData['order']->created_at)->format('H:i') }}
