<h5>Two Parallel Banners</h5>
<div class="row">
    <?php $two_parallel_banners = \App\Library\BannersHelper::getBannersAdmin()['two_parallel_banners'] ?>
    @if(count($two_parallel_banners)>0)
                    ...
                    <tr>
                        ...
                        <td class="text-center" style="width: 200px">
                            <ul class="table-controls">
                                @if($banner->order!=count($two_parallel_banners))
