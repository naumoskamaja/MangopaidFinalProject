$(document).ready(function() {
  ...
  $('.view-grid').on('click', function(event) {
    ...
    $(this).parents('.searchable-container').find('.brisi2').removeClass('col-2');
    $(this).parents('.searchable-container').find('.brisi1').removeClass('col-1');
    $(this).parents('.searchable-container').find('.add-user').addClass('display-none');
  ...
  $('.view-list').on('click', function(event) {
    ...
    $(this).parents('.searchable-container').find('.searchable-items').removeClass('grid');
      $(this).parents('.searchable-container').find('.brisi2').addClass('col-2');
      $(this).parents('.searchable-container').find('.brisi1').addClass('col-1');
      $(this).parents('.searchable-container').find('.add-user').removeClass('display-none');
