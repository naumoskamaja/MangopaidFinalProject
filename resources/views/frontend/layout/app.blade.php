...
<head>
    ...
    <!--== FancyBox CSS ==-->
    <link href="/assets/frontend/css/jquery.fancybox.min.css" rel="stylesheet"/>
    <!--== Slicknav CSS ==-->
    ...
    <link href="/assets/frontend/css/meteor-menu.css" rel="stylesheet"/>
    <link href="/assets/frontend/css/lang.css" rel="stylesheet"/>
    <link href="/assets/frontend/css/menu.css" rel="stylesheet"/>
    <link href="/assets/frontend/css/sidebar-filter.css" rel="stylesheet"/>
    <link href="/assets/frontend/css/cart-mobile.css" rel="stylesheet"/>
    <link href="/assets/frontend/css/currency.css" rel="stylesheet"/>
...
<div class="wrapper home-default-wrapper">
    ...
    @include('frontend.layout.parts.search-menu')
    @include('frontend.layout.modals.add-cart')
    @include('frontend.layout.modals.cart-menu')
    @include('frontend.layout.modals.profile-menu')
    @include('frontend.layout.modals.lang-menu')
    @include('frontend.layout.modals.currency-menu')
{{--    @include('frontend.layout.modals.quick-view')--}}
    @include('frontend.layout.parts.side-menu')
</div>
...
<script>
    function handleMarquee() {
        ...
        // header text move faster on scroll
