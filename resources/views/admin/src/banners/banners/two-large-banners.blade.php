<h5>Two Large Banners</h5>
<div class="row">
    <?php $two_large_banners = \App\Library\BannersHelper::getBannersAdmin()['two_large_banners'] ?>
    @if(count($two_large_banners)>0)
        <div class="col-12 pt-3 pb-3">
            <table class="table table-striped">
                ...
                <tbody>
                @foreach($two_large_banners as $banner)
                    <tr>
                        <td>
                        ...
                        <td>
                            <span>Two Large Banners (680px/960px)</span>
                        </td>
                        <td>{{$banner->order}}</td>
                        <td>
                            @if($banner->status == 0)
                        ...
                        <td class="text-center" style="width: 200px">
                            <ul class="table-controls">
                                @if($banner->order!=count($two_large_banners))
