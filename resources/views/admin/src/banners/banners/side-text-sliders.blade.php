<h5>Sliders with side text</h5>
<div class="row">
    <?php $side_text_sliders = \App\Library\BannersHelper::getBannersAdmin()['side_text_sliders'] ?>
    @if(count($side_text_sliders)>0)
        <div class="col-12 pt-3 pb-3">
            <table class="table table-striped">
                ...
                <tbody>
                @foreach($side_text_sliders as $banner)
                    <tr>
                        <td>
                        ...
                        <td>
                            <span>Second Slider (680px/960px)</span>
                        </td>
                        <td>{{$banner->order}}</td>
                        <td>
                            @if($banner->status == 0)
                        ...
                        <td class="text-center" style="width: 200px">
                            <ul class="table-controls">
                                @if($banner->order!=count($side_text_sliders))
